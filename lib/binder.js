angular.module('OmniBinder', [])
  .factory('obBinder', ['$timeout', '$q', 'syncEvents', 'obBinderTypes', 'modelWriter', 'deltaFactory', 'rtObserver',
    function ($timeout, $q, syncEvents, obBinderTypes, modelWriter, deltaFactory, rtObserver) {
