angular.module('OmniBinder', [])
  .factory('obBinder', ['$timeout', '$q', 'syncEvents', 'binderTypes', 'modelWriter', 'deltaFactory', 'rtObserver',
    function ($timeout, $q, syncEvents, binderTypes, modelWriter, deltaFactory, rtObserver) {
