angular.module('Binder', [])
  .factory('$binder', function ($timeout, $q, unHash, syncEvents, $binderTypes, modelWriter) {
    function Binder(protocol) {
      this.protocol = protocol;
    }

    Binder.prototype.bind = function (options) {
      var binder = Object.create(this);
      ...
      binder.scope = options.scope;
      binder.model = options.model;
      binder.query = options.query;
      binder.type = options.type;
      binder.key = options.key || null;
