angular.module('OmniBinder', [])
  .factory('obBinder', ['$timeout', '$q', 'obSyncEvents', 'obBinderTypes', 'modelWriter', 'obDelta', 'obObserver',
    function ($timeout, $q, obSyncEvents, obBinderTypes, modelWriter, obDelta, obObserver) {
