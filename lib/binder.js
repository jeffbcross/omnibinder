angular.module('OmniBinder', [])
  .factory('obBinder', ['$timeout', '$q', 'obSyncEvents', 'obBinderTypes', 'modelWriter', 'deltaFactory', 'rtObserver',
    function ($timeout, $q, obSyncEvents, obBinderTypes, modelWriter, deltaFactory, rtObserver) {
