  ...
  .factory('binder', ['$timeout', '$q', 'unHash', 'syncEvents', 'binderTypes', 'modelWriter',
    function ($timeout, $q, unHash, syncEvents, binderTypes, modelWriter) {
      ...
      Binder.prototype.push = function (newVal) {
        ...
        var delta = {data: newVal, type: syncEvents.PUSH};
      ...
      Binder.prototype.pop = function () {
        ...
        this.sendToProtocol({type: syncEvents.POP, data: null})
      }

      Binder.prototype.sendToModel = function (delta) {
        switch(delta.type) {
          case syncEvents.CREATE:
      ...
      */
      Binder.prototype.sendToProtocol = function (delta) {
        switch (delta.type) {
          ...
          case syncEvents.PUSH:
            this.protocol[this.protocol.add ? 'add' : 'change'](this, delta);
            break;

          case syncEvents.POP:
            this.protocol[typeof this.protocol.pop === 'function' ? 'pop' : 'change']();
            break;
