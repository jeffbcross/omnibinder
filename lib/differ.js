angular.module('Binder')
  .factory('differ', ['syncEvents', function (syncEvents) {
    function Differ () {}
    ...
    Differ.prototype.findRemovedString = function (binder, delta) {
      ...
      delta.type = syncEvents.DELETED;
      delta.type = removed && removed.length !== (delta.oldVal.length - delta.newVal.length) ? syncEvents.UPDATED : syncEvents.DELETED;
    ...
    Differ.prototype.findChangedString = function (binder, delta) {
      ...
      delta.position = start;
      delta.type = angular.equals(delta.newVal, delta.oldVal, true) ? syncEvents.NONE : syncEvents.UPDATED;
